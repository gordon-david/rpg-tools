...
import { DerivedCharacteristic, GurpsBasicAttribute, GurpsCharacterModel, GurpsSkill, SkillDifficulty } from "../core/gurps/GurpsCharacter"
...
describe("Gurps Character Model", function () {
  ...
  describe("Character", () => {
    test("characteristics tied to attributes on initialization", () => {
      ...
      expect((c.basicTraits['hitPoints'] as DerivedCharacteristic).derivedAttribute.key)
