import { DNDCharacter, Ability, ProficiencyBonus, Skill, Save, AbilityName, SkillName } from "./DNDCharacter"
...
describe("Skill", () => {
  ...
  test("access important fields", () => {
    const skill = new Skill(SkillName.acrobatics, { derivedAbility: new Ability(AbilityName.dexterity), derivedProficiency: new ProficiencyBonus() })
